...
if __name__ == "__main__":
    ...
    clusterers = [Clusterer(combined_classifier=cfg.model_source,
                            dataset_name=dataset_name,
                            featurization_function=featurizing_function,
                            default_embeddings=cfg.default_embeddings,
                            embeddings_path=join(cfg.external_embeddings_dir, dataset_name, f'{dataset_name}_embeddings.json'),
                            clusterer='dbscan') for dataset_name in cfg.datasets]
